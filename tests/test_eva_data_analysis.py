...
def test_calculate_crew_size(input_value, expected_result):
    ...
    for typical numbers of crew members.
    """
...
def test_calculate_crew_size_edge_cases():
    """
    Test that calculate_crew_size returns expected ground truth values for edge cases
...
def test_text_to_duration_float():
    ...
    typical durations with a non-zero minute component.
    """
